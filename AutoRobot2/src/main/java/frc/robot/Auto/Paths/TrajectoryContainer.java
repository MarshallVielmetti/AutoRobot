...
public class TrajectoryContainer {
    ...
    public TrajectoryContainer(Pose2d initialPose, ArrayList<Translation2d> interiorWaypoints, Pose2d endingPose,
            double maxVelocity, double maxAcceleration, double centripetalAcceleration, double maxAutoWheelVelocity) {
        ...
        m_kinematicsConstraint = new DifferentialDriveKinematicsConstraint(driveKinematics, maxAutoWheelVelocity);
    ...
    public TrajectoryContainer(Pose2d initialPose, ArrayList<Translation2d> interiorWaypoints, Pose2d endingPose) {
        this(initialPose, interiorWaypoints, endingPose, Constants.maxAutoVelocity, Constants.maxAutoAcceleration,
                Constants.maxCentripetalAcceleration, Constants.maxAutoWheelVelocity);
    }
